  ...
  return (
    <main>
      <section>
        ...
        <Accordion className="accordion">
          <Accordion.Item className="accordion-item" id="experience" >
            <Accordion.Title className="accordion-item-title">We got 20 years experience</Accordion.Title>
          ...
          <Accordion.Item className="accordion-item" id="local-guide" >
            ...
            <Accordion.Content className="accordion-item-content">
              <article>
                ...
                <p>We are working with local guides with to ensure a safe and pleasant vacation.</p>
              </article>
            </Accordion.Content>
          </Accordion.Item>
        </Accordion>
      ...
      <section>
        ...
        <SearchableList items={["item1", "item2"]} itemKeyFn={item => item}>{(item) => item}</SearchableList>
      </section>
    </main>
  )
